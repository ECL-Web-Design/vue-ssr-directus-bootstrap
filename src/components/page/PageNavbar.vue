        ...
        <div class="navbar-inner">
            <div class="nav-left">
                <site-logo-name :site-logo-src="siteSettingsStore?.constructedLogo.src ?? ''"
                                :site-name="siteSettingsStore.settings?.site_name ?? ''"
                ...
                <div :class="{'mobile-open' : mobileOpen}" class="routes-wrapper">
                    ...
                    <ol class="page-routes">
                        <li v-for="(route, index) in navRoutes" :key="index" class="page-item">
                            <router-link :to="route.route" class="page-link" @click="onMobileClose">{{
                                    route.label
                                }}
                            </router-link>
                        </li>
...
.page-navbar {
  ...
  z-index: 1000;
  border-bottom: 1px solid var(--text-more-subtle);
  box-shadow: var(--soft-shadow);
